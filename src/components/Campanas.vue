<template>
      ...
      <tbody>
        <tr v-for="c in [...campanas].reverse()" :key="c.id">
          ...
          <td class="activeColum align-middle">
            <div
              class="status-indicator d-flex flex-column align-items-center justify-content-center"
            >
              <div v-if="c.activa == 2" class="cerrada-label">CERRADA</div>

              <label v-if="c.activa != 2" class="toggle-switch">
                <input
                  class="slideActive"
                  type="checkbox"
                  :checked="c.activa != 0"
          ...
          <td class="align-middle text-center">
            <i
              ...
              @click="cargarEstadisticasCampaña(c.id)"
            ></i>
          </td>
        </tr>
      </tbody>
  ...
  <div
    class="modal modal-premium-glass"
          ...
          <div class="card text-white mb-4 shadow-sm card-campaign">
            <div class="card-body">
              ...
              <p v-if="datosEstadisticas" class="card-text small">
                Enviados: {{ datosEstadisticas.total_enviados }} | Respuestas:
                {{ datosEstadisticas.total_respuestas }} | %:
...
const campanasTest = [
  {
    id: 1,
    nombre_lanzamiento: "Nocturne des Cimes",
    artista: "Ensemble Lumière",
    tipo_de_lanzamiento: "Álbum",
    music_genre: "Classical",
    enlace: "https://youtu.be/abc123",
    fecha_creacion: "2025-07-10 14:30:00",
    sender_name: "Claire Dumas",
    activa: 1,
  },
  {
    id: 2,
    nombre_lanzamiento: "Echoes of Han",
    artista: "Seo Yuna Trio",
    tipo_de_lanzamiento: "EP",
    music_genre: "Jazz",
    enlace: "https://youtu.be/def456",
    fecha_creacion: "2025-07-11 10:20:00",
    sender_name: "Yuna Seo",
    activa: 1,
  },
  {
    id: 3,
    nombre_lanzamiento: "Raíces del Sur",
    artista: "Grupo Tierra Libre",
    tipo_de_lanzamiento: "Single",
    music_genre: "World",
    enlace: "https://youtu.be/ghi789",
    fecha_creacion: "2025-07-12 18:45:00",
    sender_name: "Carlos Molina",
    activa: 0,
  },
  {
    id: 4,
    nombre_lanzamiento: "Весенний свет",
    artista: "Ансамбль Белый Ветер",
    tipo_de_lanzamiento: "Álbum",
    music_genre: "Classical",
    enlace: "https://youtu.be/jkl012",
    fecha_creacion: "2025-07-13 09:10:00",
    sender_name: "Irina Volnova",
    activa: 1,
  },
  {
    id: 5,
    nombre_lanzamiento: "Desierto Azul",
    artista: "Luz y Arena",
    tipo_de_lanzamiento: "EP",
    music_genre: "World",
    enlace: "https://youtu.be/mno345",
    fecha_creacion: "2025-07-14 12:00:00",
    sender_name: "Gabriela M.",
    activa: 2,
  },
  {
    id: 6,
    nombre_lanzamiento: "Moonlight Sketches",
    artista: "The Velvet Quintet",
    tipo_de_lanzamiento: "Single",
    music_genre: "Jazz",
    enlace: "https://youtu.be/pqr678",
    fecha_creacion: "2025-07-15 13:50:00",
    sender_name: "J. Hillman",
    activa: 1,
  },
  {
    id: 7,
    nombre_lanzamiento: "Montagnes Sacrées",
    artista: "Trio Nomade",
    tipo_de_lanzamiento: "Álbum",
    music_genre: "World",
    enlace: "https://youtu.be/stu901",
    fecha_creacion: "2025-07-16 17:20:00",
    sender_name: "Luc Renard",
    activa: 0,
  },
  {
    id: 8,
    nombre_lanzamiento: "Haenyeo",
    artista: "Nam Jisoo Project",
    tipo_de_lanzamiento: "EP",
    music_genre: "World",
    enlace: "https://youtu.be/vwx234",
    fecha_creacion: "2025-07-17 20:00:00",
    sender_name: "Nam Jisoo",
    activa: 1,
  },
  {
    id: 9,
    nombre_lanzamiento: "Suite para un Río",
    artista: "Orquesta Nuevo Ande",
    tipo_de_lanzamiento: "Álbum",
    music_genre: "Classical",
    enlace: "https://youtu.be/yz1234",
    fecha_creacion: "2025-07-18 08:25:00",
    sender_name: "R. Valdivia",
    activa: 1,
  },
  {
    id: 10,
    nombre_lanzamiento: "Frozen Stars",
    artista: "Nordic Pulse Ensemble",
    tipo_de_lanzamiento: "Single",
    music_genre: "Classical",
    enlace: "https://youtu.be/abc567",
    fecha_creacion: "2025-07-19 11:15:00",
    sender_name: "E. Johansen",
    activa: 0,
  },
  {
    id: 11,
    nombre_lanzamiento: "La Tarde Azul",
    artista: "Dúo Bruma",
    tipo_de_lanzamiento: "EP",
    music_genre: "Jazz",
    enlace: "https://youtu.be/def890",
    fecha_creacion: "2025-07-20 14:55:00",
    sender_name: "Lucía Barrios",
    activa: 2,
  },
  {
    id: 12,
    nombre_lanzamiento: "Зов земли",
    artista: "Голос Байкала",
    tipo_de_lanzamiento: "Álbum",
    music_genre: "World",
    enlace: "https://youtu.be/ghi321",
    fecha_creacion: "2025-07-21 19:30:00",
    sender_name: "Yelena M.",
    activa: 1,
  },
  {
    id: 13,
    nombre_lanzamiento: "Bordes",
    artista: "Cecilia Collazos",
    tipo_de_lanzamiento: "Ep",
    music_genre: "World music",
    enlace: "https://youtu.be/ghi321",
    fecha_creacion: "2025-07-21 19:30:00",
    sender_name: "Morgana Aoul.",
    activa: 1,
  },
  {
    id: 14,
    nombre_lanzamiento: "Corre y salta",
    artista: "Nena pioson",
    tipo_de_lanzamiento: "Álbum",
    music_genre: "Jazz",
    enlace: "https://youtu.be/ghi321",
...
const respuestasPorDia = estadisticasSimuladas.respuestas.reduce(
  (acc, fecha) => {
